...
echo "   cd spring-petclinic-config-server && mvn spring-boot:run"
echo ""
echo "2. Discovery Server (REQUIRED - must start second)"
echo "   cd spring-petclinic-discovery-server && mvn spring-boot:run"
echo ""
echo "3. Customers Service"
echo "   cd spring-petclinic-customers-service && mvn spring-boot:run"
echo ""
echo "4. Vets Service"
echo "   cd spring-petclinic-vets-service && mvn spring-boot:run"
echo ""
echo "5. Visits Service"
echo "   cd spring-petclinic-visits-service && mvn spring-boot:run"
echo ""
echo "6. API Gateway"
echo "   cd spring-petclinic-api-gateway && mvn spring-boot:run"
echo ""
echo "7. GenAI Service (Optional - requires OpenAI API key)"
echo "   cd spring-petclinic-genai-service && mvn spring-boot:run"
echo ""
echo "======================================================"
