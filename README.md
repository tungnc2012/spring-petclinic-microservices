...
|-----------|------------|----------------|
| **Owners** |  |  |
| **GET** | `/api/customer/owners` | Retrieve all pet owners |
| **GET** | `/api/gateway/owners/{ownerId}` | Get a pet owner by ID |
| **POST** | `/api/owners` | Add a new pet owner |
| **PUT** | `/api/customer/owners/{ownerId}` | Update an owner’s details |
| **DELETE** | `/api/owners/{ownerId}` | Delete an owner |
| **GET** | `/api/customer/owners/{ownerId}/pets/{petId}` | Get a pet by ID (owner’s pet) |
| **PUT** | `/api/customer/owners/{ownerId}/pets/{petId}` | Update pet details (owner’s pet) |
| **POST** | `/api/customer/owners/{ownerId}/pets` | Add a new pet to an owner |
| **POST** | `/api/visit/owners/{ownerId}/pets/{petId}/visits` | Add a vet visit for a pet |
| **Vets** |  |  |
| **GET** | `/api/vet/vets` | Retrieve all veterinarians |
